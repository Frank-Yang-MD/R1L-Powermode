...
vendor/melco/efw/VehiclePwrMgr/VehiclePowerDaemon/vehiclepowerdaemon_tests_coverage/linux_glibc_x86_64

tests_bin=${android_root}/out/host/linux-x86/nativetest64/\
vehiclepowerdaemon_tests_coverage/vehiclepowerdaemon_tests_coverage

src_dir=${android_root}/vendor/melco/efw/VehiclePwrMgr/VehiclePowerDaemon

test_name="VehiclePowerDaemon"
################################################################################
